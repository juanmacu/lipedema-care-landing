  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Siluetas femeninas estilizadas - opacity reducida */}
        ...
        {/* Resto de elementos decorativos con opacidad reducida */}
        ...
        <div className="absolute bottom-1/3 left-1/4 opacity-6">
        ...
        {/* Resto de elementos decorativos - conservar estructura */}
        <div className="absolute top-20 right-20 opacity-6 transform -rotate-45">
        ...
        <div className="absolute bottom-40 left-20 opacity-4 transform rotate-30">
        ...
        <div className="absolute top-1/2 left-10 opacity-4">
          <div className="w-24 h-24 rounded-full border-2 border-zambrano-light-blue"></div>
        </div>
        
        <div className="absolute top-1/3 right-1/3 opacity-6">
          <div className="w-16 h-16 rounded-full bg-zambrano-light-blue/20"></div>
        </div>

        <div className="absolute top-32 left-1/3 opacity-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
          <div className="w-full md:w-1/2 order-2 md:order-1">
            <div className="animate-fade-in opacity-0" style={{ animationDelay: "200ms", animationFillMode: "forwards" }}>
              ...
              <p className="text-lg md:text-xl lg:text-2xl mb-6 md:mb-8 font-quicksand animate-fade-in opacity-0 text-zambrano-gray/90 tracking-wide" style={{ animationDelay: "400ms", animationFillMode: "forwards" }}>
              ...
              <p className="text-base md:text-lg mb-8 font-quicksand animate-fade-in opacity-0 text-zambrano-gray/80 leading-relaxed" style={{ animationDelay: "500ms", animationFillMode: "forwards" }}>
                El lipedema es una enfermedad progresiva que afecta el tejido graso. Si presentas síntomas, una valoración médica puede ayudarte a encontrar el tratamiento adecuado.
              </p>
              
              <div className="space-y-4 animate-fade-in opacity-0" style={{ animationDelay: "600ms", animationFillMode: "forwards" }}>
                <Button 
                  onClick={() => scrollToSection('valoracion')}
                  size="lg"
                  className="bg-zambrano-light-blue hover:bg-zambrano-light-blue/90 text-zambrano-dark-blue px-6 md:px-8 py-4 md:py-6 text-base md:text-lg rounded-md flex items-center gap-2 transform transition-all duration-300 hover:scale-105 hover:shadow-lg group w-full md:w-auto justify-center"
                >
                ...
                <Button 
                  onClick={() => scrollToSection('tipos-lipedema')}
                  variant="outline"
                  size="lg"
                  className="border-zambrano-dark-blue text-zambrano-dark-blue hover:bg-zambrano-dark-blue hover:text-white px-6 md:px-8 py-4 md:py-6 text-base md:text-lg rounded-md flex items-center gap-2 transform transition-all duration-300 hover:scale-105 hover:shadow-lg group w-full md:w-auto justify-center"
                >
              ...
              <p className="mt-4 md:mt-6 text-zambrano-gray/80 animate-fade-in opacity-0 text-center md:text-left" style={{ animationDelay: "800ms", animationFillMode: "forwards" }}>
